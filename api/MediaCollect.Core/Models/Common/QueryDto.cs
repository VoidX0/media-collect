...
public class QueryDto
{
    ...
    /// <param name="convertFieldName"></param>
    /// <returns></returns>
    public OperateResult<List<IConditionalModel>> GetConditions(ISqlSugarClient client, bool convertFieldName = true)
    {
        Condition ??= [];
        try
        {
    ...
    /// <param name="convertFieldName"></param>
    /// <returns></returns>
    public OperateResult<List<OrderByModel>> GetOrders(ISqlSugarClient client, bool convertFieldName = true)
    {
        Order ??= [];
        try
        {
